...
CREATE TABLE LegInstance (
    ...
    PRIMARY KEY(flight_leg_no, flight_number, leg_instance_data),
    FOREIGN KEY(flight_leg_no) REFERENCES FlightLeg(flight_leg_no),
    FOREIGN KEY(flight_number) REFERENCES Flight([number]),
...
CREATE TABLE Seat (
    ...
    PRIMARY KEY(seat_no, leg_instance_data, flight_leg_no, flight_number),
    FOREIGN KEY(flight_leg_no) REFERENCES FlightLeg(flight_leg_no),
    FOREIGN KEY(flight_number) REFERENCES Flight([number]),
    FOREIGN KEY(leg_instance_data) REFERENCES LegInstance(leg_instance_data)
);