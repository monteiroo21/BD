...
Fornecedor(nome, NIF*, address, FAX, cond_pagamento)
...
```
Encomenda - Produto : NM (num_unidades), grau -> binário, participação da encomenda obrigatória (uma encomenda tem de ter produto)
Encomenda - Fornecedor : *..1, grau -> binário, participação da encomenda obrigatória (uma encomenda tem de ter fornecedor)
Fornecedor - Tipo Fornecedor : *..1, grau -> binário, participação do Fornecedor obrigatória (um fornecedor tem de ter um tipo)
```
